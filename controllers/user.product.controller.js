...
// const { unsubscribe } = require('../routes/user.routes')
...
exports.create = function(req, res){
    ...
    User.updateOne({username:username},{$push:{products:products}}, (err,result)=>{
        if(err){
            res.json({status:false, data: err})
        }else{
            res.json({status:true, data:result})
...
exports.update = function (req,res){
    ...
    User.updateOne({username:username, "products.product":product},
